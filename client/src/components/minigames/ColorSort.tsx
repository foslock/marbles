...
function fallDuration(marbleIdx: number): number {
  return Math.max(420, 1350 - marbleIdx * 42);
}

export function ColorSort({ onScoreUpdate, config }: MinigameComponentProps) {
  ...
  }, []); // stable — reads only refs and sequence (a ref itself)
